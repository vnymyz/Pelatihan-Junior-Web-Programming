  ...
  <div class="max-w-6xl mx-auto">
    ...
    <div class="mb-4 flex flex-col md:flex-row md:items-center md:justify-between gap-2">
      ...
      <form method="GET" action="" class="flex gap-2">
        ...
        <button type="submit" class="bg-indigo-600 text-white px-3 py-2 rounded text-sm">Cari</button>
        <?php if ($searchQuery !== ''): ?>
              ...
              <tr class="hover:bg-gray-50">
                ...
                <td class="px-4 py-3 text-center align-top">
                  <div class="inline-flex items-center gap-2">
                    <a href="edit.php?id=<?= $a['id'] ?>" class="text-indigo-600 text-sm px-2 py-1 rounded hover:bg-indigo-50">Edit</a>

                    <form action="delete.php" method="POST" onsubmit="return confirm('Hapus artikel ini?');" class="inline">
                      <input type="hidden" name="id" value="<?= $a['id'] ?>">
                      <button type="submit" class="text-red-600 text-sm px-2 py-1 rounded hover:bg-red-50">Hapus</button>
                    </form>

                    <a href="<?= '../../articles.php?slug=' . e($a['slug']) ?>" target="_blank" class="text-gray-600 text-sm px-2 py-1 rounded hover:bg-gray-100">Lihat</a>
                  </div>
                </td>
              </tr>
            <?php endforeach; ?>
