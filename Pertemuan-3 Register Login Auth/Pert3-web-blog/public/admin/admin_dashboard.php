  ...
  <div class="max-w-4xl mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div class="bg-white rounded-lg p-6 shadow">
        ...
        <a href="articles_admin.php" class="text-indigo-600 mt-3 inline-block">Buka manajemen artikel →</a>
      </div>

      <div class="bg-white rounded-lg p-6 shadow">
        <h3 class="font-semibold">Kelola Komentar</h3>
        <p class="text-sm text-gray-500 mt-2">Review pesan atau komentar dari pengunjung.</p>
        <a href="komentar.php" class="text-indigo-600 mt-3 inline-block">Lihat komentar →</a>
      </div>
    </div>
  </div>
</main>
